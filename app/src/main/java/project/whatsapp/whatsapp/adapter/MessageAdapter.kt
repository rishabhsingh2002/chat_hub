...
import project.whatsapp.whatsapp.databinding.ReceiverItemLayoutBinding
import project.whatsapp.whatsapp.databinding.SentItemLayoutBinding
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
       val message = list[position]
        ...
        if (holder.itemViewType == ITEM_SENT){
            ...
            viewHolder.binding.tvReceiveMessage.text = message.message
        }
    }
